    ...
    pnames <- as.character(c('PhC','SoC','SoN','Sor'))

    SG.pooldata <- popsync2pooldata(sync.file = '/media/inter/mkapun/projects/ABBABABA_Sepsis/results/f4_new/SoC_PhC.sync.gz', 
        poolsizes = psizes, 
        poolnames = pnames,
    ...
    write.table(NEW,
    file='/media/inter/mkapun/projects/ABBABABA_Sepsis/results/f4_new/SoC_PhC_f4.stat',
    quote=F)
