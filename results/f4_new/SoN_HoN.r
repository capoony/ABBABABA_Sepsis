    ...
    pnames <- as.character(c('HoN','SoN','SoC','Sor'))

    SG.pooldata <- popsync2pooldata(sync.file = '/media/inter/mkapun/projects/ABBABABA_Sepsis/results/f4_new/SoN_HoN.sync.gz', 
        poolsizes = psizes, 
        poolnames = pnames,
    ...
    write.table(NEW,
    file='/media/inter/mkapun/projects/ABBABABA_Sepsis/results/f4_new/SoN_HoN_f4.stat',
    quote=F)
