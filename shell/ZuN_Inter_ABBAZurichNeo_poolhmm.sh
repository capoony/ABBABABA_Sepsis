    ...
    mkdir /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/ABBAZurichNeo
     python3 /media/inter/mkapun/projects/ABBABABA_Sepsis/scripts/Pileup4PoolHMM.py           --input /media/inter/mkapun/projects/ABBABABA_Sepsis/data/ABBAZurichNeo.pileup.gz           --windows /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/ZuN_Inter_Candidates_FST.txt           --output /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/ABBAZurichNeo/ABBAZurichNeo           --windowsize 1000

    cd /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/ABBAZurichNeo
     for i in /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/ABBAZurichNeo/ABBAZurichNeo*.pileup; do
