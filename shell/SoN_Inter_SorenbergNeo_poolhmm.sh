    ...
    mkdir /media/inter/mkapun/projects/ABBABABA_Sepsis/results/SoN_Inter/SorenbergNeo
     python3 /media/inter/mkapun/projects/ABBABABA_Sepsis/scripts/Pileup4PoolHMM.py           --input /media/inter/mkapun/projects/ABBABABA_Sepsis/data/SorenbergNeo.pileup.gz           --windows /media/inter/mkapun/projects/ABBABABA_Sepsis/results/SoN_Inter/SoN_Inter_Candidates_FST.txt           --output /media/inter/mkapun/projects/ABBABABA_Sepsis/results/SoN_Inter/SorenbergNeo/SorenbergNeo           --windowsize 1000

    cd /media/inter/mkapun/projects/ABBABABA_Sepsis/results/SoN_Inter/SorenbergNeo
     for i in /media/inter/mkapun/projects/ABBABABA_Sepsis/results/SoN_Inter/SorenbergNeo/SorenbergNeo*.pileup; do
