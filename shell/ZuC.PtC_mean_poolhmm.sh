    ...
    mkdir /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuC.PtC_mean/ZurichCyn
     python3 /media/inter/mkapun/projects/ABBABABA_Sepsis/scripts/Pileup4PoolHMM.py           --input /media/inter/mkapun/projects/ABBABABA_Sepsis/data/ZurichCyn.pileup.gz           --windows /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuC.PtC_mean/ZuC.PtC_mean_Candidates_FST.txt           --output /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuC.PtC_mean/ZurichCyn/ZurichCyn           --windowsize 1000

    cd /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuC.PtC_mean/ZurichCyn
     for i in /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuC.PtC_mean/ZurichCyn/ZurichCyn*.pileup; do
