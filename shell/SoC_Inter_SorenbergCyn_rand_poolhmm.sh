    ...
    mkdir /media/inter/mkapun/projects/ABBABABA_Sepsis/results/poolhmm/SoC_Inter/RAND_SorenbergCyn
     ...
     python3 /media/inter/mkapun/projects/ABBABABA_Sepsis/scripts/Pileup4PoolHMM.py           --input /media/inter/mkapun/projects/ABBABABA_Sepsis/data/SorenbergCyn.pileup.gz           --windows /media/inter/mkapun/projects/ABBABABA_Sepsis/results/poolhmm/SoC_Inter/Rand_FST.txt           --output /media/inter/mkapun/projects/ABBABABA_Sepsis/results/poolhmm/SoC_Inter/RAND_SorenbergCyn/RAND_SorenbergCyn           --windowsize 1000

    cd /media/inter/mkapun/projects/ABBABABA_Sepsis/results/poolhmm/SoC_Inter/RAND_SorenbergCyn

     for i in /media/inter/mkapun/projects/ABBABABA_Sepsis/results/poolhmm/SoC_Inter/RAND_SorenbergCyn/RAND_SorenbergCyn_*.pileup; do
