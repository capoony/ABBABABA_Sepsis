    ...
    mkdir /media/inter/mkapun/projects/ABBABABA_Sepsis/results/SoN_Inter/RAND_SorenbergNeo
     ...
     python3 /media/inter/mkapun/projects/ABBABABA_Sepsis/scripts/Pileup4PoolHMM.py           --input /media/inter/mkapun/projects/ABBABABA_Sepsis/data/SorenbergNeo.pileup.gz           --windows /media/inter/mkapun/projects/ABBABABA_Sepsis/results/SoN_Inter/Rand_FST.txt           --output /media/inter/mkapun/projects/ABBABABA_Sepsis/results/SoN_Inter/RAND_SorenbergNeo/RAND_SorenbergNeo           --windowsize 1000

    cd /media/inter/mkapun/projects/ABBABABA_Sepsis/results/SoN_Inter/RAND_SorenbergNeo

     for i in /media/inter/mkapun/projects/ABBABABA_Sepsis/results/SoN_Inter/RAND_SorenbergNeo/RAND_SorenbergNeo_*.pileup; do
