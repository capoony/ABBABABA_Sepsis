    ...
    mkdir /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/RAND_ABBAZurichNeo

     # now random dataset

     WC=($(wc -l /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/ZuN_Inter_Candidates_FST.txt))
     N=${WC[0]}

     sort -R /media/inter/mkapun/projects/ABBABABA_Sepsis/results/Windows.txt |
        head -${N}          >/media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/Rand_FST.txt

     python3 /media/inter/mkapun/projects/ABBABABA_Sepsis/scripts/Pileup4PoolHMM.py           --input /media/inter/mkapun/projects/ABBABABA_Sepsis/data/ABBAZurichNeo.pileup.gz           --windows /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/Rand_FST.txt           --output /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/RAND_ABBAZurichNeo/RAND_ABBAZurichNeo           --windowsize 1000

    cd /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/RAND_ABBAZurichNeo

     for i in /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/RAND_ABBAZurichNeo/RAND_ABBAZurichNeo_*.pileup; do
