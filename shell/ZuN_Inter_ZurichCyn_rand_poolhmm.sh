    ...
    mkdir /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/RAND_ZurichCyn
     ...
     python3 /media/inter/mkapun/projects/ABBABABA_Sepsis/scripts/Pileup4PoolHMM.py           --input /media/inter/mkapun/projects/ABBABABA_Sepsis/data/ZurichCyn.pileup.gz           --windows /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/Rand_FST.txt           --output /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/RAND_ZurichCyn/RAND_ZurichCyn           --windowsize 1000

    cd /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/RAND_ZurichCyn

     for i in /media/inter/mkapun/projects/ABBABABA_Sepsis/results/ZuN_Inter/RAND_ZurichCyn/RAND_ZurichCyn_*.pileup; do
